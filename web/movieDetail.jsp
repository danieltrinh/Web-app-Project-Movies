...
<div class="container">
    ...
    <div class="row">
        ...
        <c:forEach items="${casts}" var="cast" begin="1" end="6">
            <div class="col-lg-4 col-sm-6 text-center mb-4">
                <img id="cast0img" class="rounded-circle img-fluid d-block mx-auto" src="https://image.tmdb.org/t/p/w500/${cast.profile_path}" alt="">
    ...
    <div class="row">
        <c:forEach items="${similar_movies}" var="similar_mov" begin="1" end="6">
            <div class="col-md-3 col-sm-6 mb-4">
                <a href="/movie?id=${similar_mov.id}">
                    <img id="simlar1" class="img-fluid" src="https://image.tmdb.org/t/p/w500/${similar_mov.poster_path}" alt="" title="E${similar_mov.overview}" dataid="26390">
                </a>
